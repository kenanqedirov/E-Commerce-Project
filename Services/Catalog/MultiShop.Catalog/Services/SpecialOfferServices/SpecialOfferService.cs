...
namespace MultiShop.Catalog.Services.SpecialOffer
{
    ...
    {
        private readonly IMongoCollection<Entities.SpecialOffer> _specialOfferCollection;
        private readonly IMapper _mapper;
        public SpecialOfferService(IMapper mapper, IDatabaseSettings _databaseSettings)
        {
            var client = new MongoClient(_databaseSettings.ConnectionString);
            var database = client.GetDatabase(_databaseSettings.DatabaseName);
            _specialOfferCollection = database.GetCollection<Entities.SpecialOffer>(_databaseSettings.SpecialOfferCollectionName);
            _mapper = mapper;
        }
        public async Task CreateSpecialOfferAsync(CreateSpecialOfferDto createSpecialOfferDto)
        {
            var value = _mapper.Map<Entities.SpecialOffer>(createSpecialOfferDto);
        ...
        {
            var value = _mapper.Map<Entities.SpecialOffer>(updateSpecialOfferDto);
